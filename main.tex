...
Note that $\partial \Orb(X) \subset W$ has codimension $> 5$.
...
\begin{proof}
  ...
  \begin{align*}
    \deg \mu^* \Orb(u) &= \# X \times_{\mathscr M} u \\
                       &= \# X \times_{\mathcal M} u \\
                       &= \deg m.
  \end{align*}
\end{proof}
...
We know that a cubic surfaces arise as blow ups of $\P^2$ at six points.
...
\item The image of the map $X \to \P^3$ induced by $\omega_X^{-1}$ is a cubic surface.
\item We have $H^i(X,\omega_X^{-n)}) = 0$ for all $n \geq 0$ and $i > 0$.
\item The graded ring $\bigoplus_n H^0\left(X, \omega_X^{-n}\right)$ is generated in degree 1.
\end{enumerate}
\end{proposition}
\begin{proof}
  ...
  Let $E \subset X$ be the exceptional divisor, namely, the Cartier divisor defined by the ideal $\pi^{-1}I_Z$.
  Note that $E$ is not necessarily reduced---over the point $z$ as above, the component $E_z$ has multiplicity $n$.
  ...
  \[ \pi_* \left( \omega_X^{-1} \right) = \O_{\P^2}(3) \otimes I_Z.\]
  By our assumption, $H^0\left(\P^2, \O(3) \otimes I_Z\right)$ is $4$-dimensional and its base-locus is precisely $Z$.
  Hence $H^0\left( X, \omega_X^{-1} \right)$ is $4$-dimensional, and base-point free.

  The degree of the image of $X \to \P^2$ is the self-intersection $(\omega_X)^2$.
  Using \eqref{eqn:wx} and $E^2 = -6$, we compute
  \[ \omega_X^2 = (\omega_{\P^2})^2 - 6 = 3.\]
