...
\begin{proposition}
  ...
  $\mathcal{W} = \pi_{*}\omega_{\pi}$, i.e. $\mathcal{W} = \V$.
\end{proposition}
...
\begin{proof}
  ...
  \[ \mathcal{L} = \kappa^{*}\left( \omega_{\pi} \right).\]
  ...
  So, we conclude there is a relationship of the form
  \[c_{1} \mathcal{L} - c_{1} \left( \kappa^{*}\left( \omega_{\pi}
      \right) \right) = a\mathcal{F} + b\mathcal{S}.\] We must show
  that $a = b = 0$.  To do so, we will restrict this relation to
  certain subschemes of $\mathcal{Y}$.

  First, choose any point $e \in E_{i}$, and restrict the relation to
  $\mathcal{F}_{e} \simeq \F_{1}$.  The left hand side restricts to
  $\O_{\F_{1}}$.  The right side restricts to
  ...
  do this, we will restrict to a surface.  First, choose a general
  fiber $P \subset E_{i}$ of the blow-down map
  ...
  Note that $\mathcal{D} \simeq P \times L_{i}$.  
\end{proof} 
