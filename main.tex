...
One final remark before starting the analysis: The need for using the
alternate compactification $\hM_{0,7}$ ultimately traces to the
...
Certain divisors on $\hM_{0,n}$ will play an essential role in our
