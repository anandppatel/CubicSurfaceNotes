...
Salmon discovered the 27 lines, it has become a tradition for
algebraic geometers to revisit their geometry, using increasingly
sophisticated tools to uncover more and more. Our contribution to
this story provides a universal answer to a large collection of
natural enumerative questions about families of cubic surfaces.
...
\end{enumerate}
We will establish an enumerative formula that answers all questions of
this kind.  (The answers to these specific questions are $96120$,
$42120$, and $25920$, respectively).

To state our formula, we must fix a precise moduli space for the
...
$F \in \Sym^d V^\vee$.  In $\P\Sym^dV^\vee$, consider the orbit of $[F]$ under
the action of $\GL(V)$, and let $\Orb([F])$ be its closure.
To our knowledge, the story begins with Enriques and Fano, who computed the degree of the orbit closure of binary forms of all degrees \cite{EF}.  
In a series of seminal papers, Aluffi and Faber computed the degree of the orbit closure for \emph{all} binary and ternany forms.
That is, the case of points in $\P^1$ and curves in $\P^2$ has been done.
The next case is that of cubic surfaces in $\P^3$, established in this paper.
\autoref{theorem:main} applied to Question~\ref{orbit} says that the degree of the orbit closure of a general cubic surface is $96120$.
...
singularities or Ekckhart points.  This is something we hope to pursue
in the future.
...
equivalence.
For the reader's amusement, we include a real picture of $X$ in \autoref{fig:cubicA5}.
...
\begin{figure}
  ...
  \caption{A family of surfaces with an accordion like central fiber arise while resolving the rational map $\P^2_\Delta \to \P^2_\Delta$.}
\end{figure}
