...
Set $\Lambda_i = \Hilb^2 L_i \subset S^{[2]}$; this $\Lambda_i$ is a copy of $\P^2$.
...
\end{lemma}
\begin{proof}
  Since $\Lambda_i = \Hilb^2 L_i$, the subscheme $(\Lambda_i \times S) \cap \mathcal Z$ is contained in $(\Lambda_i \times L_i)$.
...
\begin{proof}
  ...
  \]
  The point $\beta(e) \in \Lambda_i \subset S^{[2]}$ corresponds to the length 2 subscheme $Z \subset L_i \subset S$.
...
It is easy to check that for every $e \in \widetilde{S^{[2]}}$, the image of $\kappa(\mathcal Y_e)$ is contained in a unique cubic surface in $\P \mathcal W^\vee|_e$.
