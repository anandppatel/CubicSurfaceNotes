...
The following proposition describes the pair $(\widetilde{\mathcal Z} \subset \mathcal Y)$ over a point $e \in E_i$; see \autoref{fig:familyY} for a picture.
\begin{figure}
  \centering
    \input{figures/familyY}
    \caption{A slice of the family of surfaces $\mathcal Y \to \widetilde S^{[2]}$ and the subscheme $\widetilde {\mathcal Z} \subset \mathcal Y$.
