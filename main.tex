...
\begin{proof}[Proof of \autoref{lem:v2}]
  ...
  To compute the restriction to $\Sigma$, we view $\Sigma$ as a divisor in $\overline{\mathcal C} = \P A^\vee$ and let $ = \omega_\rho^{-1}|_{\overline C}$.
  Thus, in the Grothendieck group, we have
  \[ \rho_*(\omega_\rho^{-1}|_{\Sigma}) = \overline\phi_*\left(M\right) - \overline\phi_* \left( \O_{\overline{\mathcal C}}(D-\Sigma)\right).\]
  
  The pull-back of $\omega_\rho^{-1}$ to $\P A^\vee$ is $\O(6) \otimes \overline\phi^* \mathcal L^3 = \O(6 \cdot \overline \sigma_\infty) \otimes \overline\phi^* \mathcal L^3$.
