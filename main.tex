...
\begin{proof}[Proof of \autoref{lem:v2}]
  ...
  The result now a simple computation using $c_1(\mathcal L) = \psi_\theta$ and $\int_{\overline \M_{0,7}} \psi_\infty^4 = 1$.
\end{proof}
...
\end{proposition}
\begin{proof}
  The map lifths to $\overline \M_{0,7} \dashrightarrow \M^\dagger$,
  and since the degree of $\M^\dagger \to \M$ is $51840$, we must prove that the degree of $\overline \M_{0,7} \dashrightarrow \M^\dagger$ is $2$.

  Recall that $\M^\dagger$ is isomorphic to the configuration of 6 points in $\P^2$.
