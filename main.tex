...
history by establishing an enumerative formula which counts the number
of times the {\sl moduli} of a general cubic surface arises in
suitably generic, complete, $4$ parameter families. Applying the
formula to a few simple examples yields:
\begin{enumerate}
...
$s_{0}, s_{1}, \dots, p_{5}, s_{\infty}$ on $C$, and let
...
\begin{proof}
  This is seen by applying \autoref{prop:good}, after noting that in
