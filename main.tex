...
Let us find the degree of the map to moduli $B_1 \dashrightarrow \mathfrak M$.
\begin{lemma}\label{lem:deg1}
  The degree of $B_1 \dashrightarrow \mathfrak M$ is $4320$.
\end{lemma}
\begin{proof}
  Consider space of marked cubic surfaces $\mathfrak M^\dagger$, which is isomorphic to the configuration space of 6 ordered points on $\P^2$.
  We have the action of $S_5$ on $\mathfrak M^\dagger$ via permutations of the last 5 points.
  The map $B_1 \dashrightarrow \mathfrak M$ lifts to
  \begin{equation}\label{eqn:b1lift}
    B_1 \to \mathfrak M^\dagger / S_5,
  \end{equation}
  where $b \in B_1$ is mapped to $(z_0, z_1 + \dots + z_5)|_b$.
  Let us compute the degree of this map.
  Given a general $(y_0, y_1 + \dots + y_5)$ in $\mathfrak M^\dagger / S_5$, there is a unique conic $Q$ through $y_1 + \dots + y_5$.
  ...
  Then we have
   ...
   Since the degree of $\mathfrak M^\dagger \to \mathfrak M$ is $51840$, the degree of $B_1 \to \mathfrak M$ is
