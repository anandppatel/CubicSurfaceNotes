...
\begin{proof}
  ...
  The natural map $\alpha^* \omega_{\P^2_R/R} \to \omega_{\mathcal X'/R}$ gives a map $\omega^{-1}_{\mathcal X'/R} \to \alpha^* \omega_{\P^2_R/R}$ and hence an evaluation map
...
\begin{proof}
  ...
  If $\phi_0^\vee$ is defined for a line $\ell \in (\P^2)^\vee$, then the flat limit of the family of lines $\phi(\ell_K) \subset \P^2_K$ is the line corresponding to $\phi^\vee(\ell)$.
  ...
  For lines $\ell$ not containing $p$, the map $\phi^\vee$ is constant.

  Now, consider a line $\ell$ joining pairs of points of $Z$.
  By semi-continuity, the flat limit $T$ of $\phi(\ell_K)$ must intersect $W$ in a scheme of length at least 2.
  ...
  Suppose $L \subset \P^2$ is the line corresponding to $\phi_0^\vee(\ell)$.
  Since $\ell$ contains $z_1$, the flat limit $L$ of $\phi(\ell)$ contains the flat limit $p$ of $\phi(z_1)$.
  Since $\phi_0^\vee$ is constant on its domain, its constant value corresponds to the line $L$.
