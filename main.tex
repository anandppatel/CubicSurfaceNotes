...
\begin{proof}
  ...
  \[ \mathcal X \subset \P^3 \otimes \P^4\]
  defined by
  \[ \mathcal X = V(u_0F_0 + \dots u_4F_4),\]
  and the resulting family $\pi \colon \mathcal X \to \P^4$.
  The dimension of the set of cubic surfaces with a positive dimensional automorphism group 
  It is easy to check that $\pi$ is a good family
\end{proof}
