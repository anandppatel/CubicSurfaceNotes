...
quintic del Pezzo surface $S$ and blowing up $S$ at two points varying freely on $S$.
To formalize this construction, the obvious choice is to take the base to be $S^{[2]}$, the Hilbert scheme of 2 points on $S$.
However, a complication arises, which needs significant effort to be overcome.

Recall that a quintic del Pezzo $S$ is the blow-up of $\P^2$ at 4 general points.
It contains $10$ exceptional curves, say $L_1, \dots, L_{10}$.
The cubic surface associated to a length 2 subscheme supported on $L_i$ turns out to be in the closure of every smooth cubic surface.
As a result, the simple-minded family over $S^{[2]}$ is not good.
Most of this section is devoted to resolving this issue.

Let $\Lambda_i \subset S^{[2]}$ be the Hilbert scheme of length 2 subschemes of $L_i$.
Then $\Lambda_i$ is isomorphic to $\P^2$.
For $i \neq j$, the lines $L_i$ and $L_j$ are either disjoint or intersect in a single (reduced) point.
 Therefore, $\Lambda_i$ and  $\Lambda_j$ are disjoint.
