...
Let $B$ be a scheme, $P \to B$ an $S$-bundle, and $Z \subset  P$ a closed subscheme, flat over $B$, whose fibers are admissible subschemes of $S$.
...
Fix two points $y_1$ and $y_2$ in $\P^2$ and a conic $C \subset \P^2$ containing $y_2$.
We vary 4 points $z_1, z_2, z_3, z_4$ on $C$.
Blowing up the six points $\{z_1,\dots, z_4, y_1, y_2\}$ gives a 4-parameter family of cubic surfaces; see \autoref{fig:FamilyB1}.
\begin{figure}
  \centering
...
We now make the construction more precise.
Let $S$ denote the blow-up of $\P^2$ at two distinct points $y_1$ and $y_2$.
Let $E_{1}$ and $E_{2}$ denote the corresponding exceptional divisors on $S$.
Let $C \subset S$ be the proper transform of a general conic through $y_2$.
\begin{proposition}
  \label{prop:B1}
  Let $Z \subset S$ be a subscheme of $C$ of length 4.
  Then
  \begin{enumerate}
  \item $h^{0}(S, \mathcal{I}_{Z} \otimes \omega_{S}^{-1}) = 4$, and
  \item the evaluation map
    \[ H^0\left(S, \mathcal I_Z \otimes \omega_S^{-1}\right) \otimes \O_S \to \mathcal I_Z \otimes \omega_S^{-1}\]
    is surjective.
  \end{enumerate}
\end{proposition}
\begin{proof}
  We have the sequence
  \begin{equation}\label{eqn:zcs}
    0 \to \mathcal I_C \otimes \omega_S^{-1} \to \mathcal I_Z \otimes \omega_S^{-1} \to \mathcal I_{Z/C} \otimes \omega_S^{-1} \to 0,
  \end{equation}
  where $\mathcal I_{Z/C} \subset \O_C$ is the ideal sheaf of $Z \subset C$.
  The kernel $\mathcal I_C \otimes \omega_S^{-1}$ is a line bundle on $S$, and its divisor class is represented by proper transforms of lines in $\P^2$ passing through $y_2$.
  Since this linear series is 1-dimensional and base-point free, the space $H^0\left(\mathcal I_C \otimes \omega_S^{-1}\right)$ is $2$-dimensional and genererates $\mathcal I_C \otimes \omega_S^{-1}$.
  The cokernel $\mathcal I_{Z/C} \otimes \omega_S^{-1}$ is a line bundle supported on $C \cong \P^1$ isomorphic to $\O(1)$.
  Thus, the space $H^0\left( \mathcal I_{Z/C} \otimes \omega_S^{-1} \right)$ is $2$-dimensional and generates $\mathcal I_{C/Z} \otimes \omega_S^{-1}$.
  The long exact sequence in cohomology applied to \eqref{eqn:zcs} implies that the map
  \[H^0\left(\mathcal I_Z \otimes \omega_S^{-1}\right) \to H^0\left( \mathcal I_{Z/C} \otimes \omega_S^{-1} \right)\]
  is surjective.
  It follows that $H^0\left(\mathcal I_Z \otimes \omega_S^{-1}\right)$ is 4-dimensional and generates $\mathcal I_Z \otimes \omega_S^{-1}$.
\end{proof}
