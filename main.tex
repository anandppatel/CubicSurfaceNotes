...
\begin{proposition}\label{prop:goodness3}
  The family $\pi \colon \mathcal X \to \M_{0,7}$ is good.
\end{proposition}
\begin{proof}
  ...
  If the tangent line $T_rZ = T_rC$ does not contain $p$ or $q$, we appeal to \autoref{prop:pq4r} or \autoref{prop:2p4r}.
  Suppose $T_rZ$ contains $p$.
  Then $T_rZ$ cannot contain $q$, and hence $p, q, r$  are not collinear.
  One of $p,q,r$ must be the flex point $s_\infty$---the only possibility is $q = s_\infty$.
  Then $Z \subset C$ is uniquely determined up to an automorphism of $(\P^2, C)$.
