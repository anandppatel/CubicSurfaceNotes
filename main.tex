...
\begin{abstract}
  ...
  family.  As sample applications, we show that the $\PGL_4$ orbit closure of
...
increasingly sophisticated tools and uncover more and more. Our
contribution to this story is a universal answer to a varied
collection of enumerative questions about cubic surfaces.
...
isomorphism class should appear finitely many times. We offer 
...
\end{enumerate}
Our universal formula answers all questions of this kind -- the answers to
...
Question~\ref{orbit} in \autoref{sec:intro} fits in a broader ongoing story.  
...
the cases of points in $\P^1$ and curves in $\P^2$.  The frontier case is
...
these techniques are of independent interest, we assemble these
...
with the case of degree $1$ del Pezzo's being most challenging.

Finally, we add the equivariant version of a comment of Aluffi and
...
group.  A whole lot of work still needs to be done if we want a more general understanding,
though the new equivariant flexibility will allow
