...
\begin{equation}\label{eqn:chernexpansion}
  [\Orb(X)] = a_{1^4}c_1^4 + a_{1^2\cdot 2} c_1^2c_2 + a_{1\cdot 3} c_1c_3 + a_{2^2}c_2^2 + a_4 c_4,
\end{equation}
...
In particular, for $G = \G_m$---the only necessary case in our case---we can take $B$ to be an arbitrary $\G_m$-torsor (line bundle minus the zero section) over a scheme.
...
\begin{equation}\label{eqn:isorel}
  0 = a_{1^4}c_1^4 + a_{1^2\cdot 2} c_1^2c_2 + a_{1\cdot 3} c_1c_3 + a_{2^2}c_2^2 + a_4 c_4,
\end{equation}
where $c_i$ are the Chern classes of the push-forward of the anticanonical bundle.
...
In other words, $X \subset \P V$ is the zero locus of the line bundle $\O(3) \otimes \pi^*\chi(-w)$ in the projective bundle $\pi \colon [\P V/\G_m] \to B\G_m$.
...
\[ c_1 = 0, \quad c_2 = (ab+bc+ca) \cdot q^2, \quad c_3 = abc \cdot q^3, \quad c_4 = 0,\]
and hence
\[ c_1^4 = 0, \quad c_1^2c_2 = 0, \quad c_1c_3 = 0,\quad c_2^2 \neq 0, \quad c_4 = 0.\]
...
\[ c_1 = -4q, \quad c_2 = -16q^2, \quad c_3 = 64q^3, \quad c_4 = 0,\]
and hence
\[ c_1^4 = 256q^4 \quad c_1^2c_2 = -256q^4, \quad c_1c_3 = -256q^4, \quad c_2^2 = 256q^4, \quad c_4 = 0.\]
Substituting in \eqref{eqn:isorel} yields the relation
...
Setting $q = c_1(\chi(1)) \in A^1(B\G_m)$, we get
\[ c_1 = 4q, \quad c_2 = -4q^2, \quad c_3 = -16q^3, \quad c_4 = 0,\]
and hence
\[ c_1^4 = 256q^4 \quad c_1^2c_2 = -64q^4, \quad c_1c_3 = -64q^4, \quad c_2^2 = 16q^4, \quad c_4 = 0.\]
Substituting in \eqref{eqn:isorel} yields the relation
...
\[ c_1 = 12q, \quad c_2 = 16q^2, \quad c_3 = -192q^3, \quad c_4 = -512q^4,\]
and hence
\[ c_1^4 = 20736q^4 \quad c_1^2c_2 = 2304q^4, \quad c_1c_3 = -2304q^4, \quad c_2^2 = 256q^4, \quad c_4 = -512q^4.\]
Substituting in \eqref{eqn:isorel} yields the relation
