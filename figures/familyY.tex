\begin{tikzpicture}[very thick]
  ...
  \begin{scope}[yshift=2cm, scale=1.25]
    ...
    \draw (230:1) edge [thin, dashed, bend right=10] (-0.3,0.86)
    (-0.3,0.86) circle (0.05);
    \draw (280:1) edge [thin, dashed] (0,0.86)
    (0,0.86) circle (0.05);
    \draw (330:1) edge [thin, dashed, bend left=10] (0.3,0.86)
    (0.3,0.86) circle (0.05);
    \draw (315:1.25) node {$S$};
