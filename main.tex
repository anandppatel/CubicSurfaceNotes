...
\begin{proof}
  ...
  See that the orbit of $H$ under $\Aut(\widetilde Y)$ is finite.
  ...
  Since any automorphism of $\widetilde Y$ preserves $\omega_{\widetilde Y}$ and the self-intersection number.
  ...
  Note that we have
  \[ \beta_* \left(\omega_{\widetilde Y}^{-1}\right) = \omega^{-1}_{\P^2} \otimes \mathcal I_Z,\]
  and hence
