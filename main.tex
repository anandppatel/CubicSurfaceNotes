...
interest of exposition, we have placed it in \autoref[???].


The following theorem takes care of goodness over $B_{3} \setminus T$.
...
\begin{theorem}
  ...
  interpreted as a divisor on $C$, is admissible and $\Aut(\P^{2},Z)$
  is finite.
\end{theorem}
...
\begin{proof}
  ...
  $Q$ and its relative position with respect to the cuspidal cubic
  $C$.  Observe first that every element in the identity component of
