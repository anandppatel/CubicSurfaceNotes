...
encounter technical challenges with some of the constructions.  To
...
surfaces.  What is required is to prove statements of the form: ``The
particular cubic surface $S$ is not in the closure of a suitably
generic cubic surface.''  We develop a range of tools to address
...
automorphism groups of cubic surfaces.  We wonder if $1080$ is the
minimal positive integer realizable as $\deg \mu$ as we vary across
all good families of cubic surfaces.
