...
\begin{proposition}
  ...
  $H^{0}(\F_{1}, \O_{\F_{1}}(3L_{i}-D) \otimes \mathcal I_{\tau_{i}}).$
\end{proposition}
...
So, let $\mathcal{Y}' = \Bl_{\td{\mathcal{Z}}}\mathcal{Y}$ and let
$\pi': \mathcal{Y}' \to \td{S^{[2]}}$ denote the obvious
map. Furthermore, let $\mathcal{F}' \subset \mathcal{Y}'$ denote the
preimage of $\mathcal{F} \subset \mathcal{Y}$ under the blowdown;
$\mathcal{F}'$ is a Cartier divisor in $\mathcal{Y}'$. Under $\pi'$,
$\mathcal{Y}'$ is a family of surfaces which, over
$U \subset \td{S^{[2]}}$ is a good family of cubic surfaces, and over
a point $e \in E_{i}$ has $2$-component fiber
\begin{align}
  \label{eq:Yprimefiber}
  S \cup_{L_{i}} \Bl_{\td{\mathcal{Z}}_{e}} \F_{1}.
\end{align}
Here, ``$\cup_{L_{i}}$'' emphasizes that the surfaces meet
transversely along $L_{i}$ according to the description found in
\autoref{prop:geometry} part (1).
