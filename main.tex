...
The base of a good family naturally carries the natural rank $4$
vector bundle
\begin{align}
  \label{eq:V}
  V := \omega_{X/B}^{-1}.
...
\begin{align}
  ...
  B_1 = C^{[4]} \simeq \P^{4}.
\end{align}
 $B_1$ carries a general family of cubic surfaces over it.
...
Assuming this fact, we arrive at our first relation:
